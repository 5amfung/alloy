...
export default function Personalization() {
  ...
  return (
    <div>
      ...
      <p>
        Personalized content should be shown below for all visitors. The
        activity uses a "__view__" scope.
      </p>
      ...
      <p>
        ...
        "product" and "cart", respectively. Each view's personalized content
        contains a button whose clicks are tracked as conversions in Target.
      </p>
      <ul>
        <li>
